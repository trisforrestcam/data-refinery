 ...
 * Cho phép tính lại dữ liệu cho match cụ thể trong khoảng thờ gian tùy chọn.
 */
export class BackfillJobDto {
  ...
  @ApiPropertyOptional({
    description: 'Thờ điểm kết thúc (ISO 8601). Nếu không có, tính đến hiện tại',
  ...
  @ApiPropertyOptional({
    description: 'Khoảng thờ gian mỗi interval (phút). Mặc định 5 phút',
    example: 5,
    default: 5,
  })
  @IsOptional()
